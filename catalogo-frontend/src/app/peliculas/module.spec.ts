...
describe('Modulo Peliculas', () => {
  const apiURL = environment.apiURL + 'peliculaes'
  const dataMock = [
  ...
  describe('ViewModelService', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        providers: [NotificationService, LoggerService,
          {
            provide: PeliculasDAOService, useFpeliculay: () => new DAOServiceMock<Pelicula, number>([...dataMock])
          }
        ],
      });
    ...
    describe('mode', () => {
      ...
      it('add', () => {
        service.add()
        expect(service.Elemento).withContext('Verify Elemento').toEqual(new Pelicula())
